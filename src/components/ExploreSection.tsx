  ...
  const mockProperties = [
    {
      ...
      rating: 4.8,
      reviews: 234,
      image: 'public/images/vangel-dimo-6FRwt9vE368-unsplash.jpg',
    ...
    },
    {
      ...
      rating: 4.9,
      reviews: 167,
      image: 'public/images/soban-ahmed-7y0m7VJ-7nk-unsplash.jpg',
    ...
    },
    {
      ...
      rating: 4.7,
      reviews: 89,
      image: 'public/images/roberto-nickson--UpZzX87_tc-unsplash.jpg',
    ...
    },
    {
      ...
      rating: 4.6,
      reviews: 156,
      image: 'public/images/matthew-sichkaruk-hUUIPXXMTeM-unsplash.jpg',
          ...
          {mockProperties.map((property) => (
            <Card key={property.id} className="overflow-hidden travel-card-hover group cursor-pointer">
              <div className="relative h-64">
                <img
                  src={
                    property.image.startsWith('public/') || property.image.startsWith('/images/')
                      ? property.image.replace(/^public\//, '/')
                      : `https://images.unsplash.com/${property.image}?w=600&h=400&fit=crop`
                  }
                  alt={property.title}
