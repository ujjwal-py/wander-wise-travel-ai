        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2">
            <div className="p-2 bg-travel-gradient rounded-lg">
              <img src="/images/WanderVia Travel and Technology Logo.png" alt="WanderVia Logo" className="h-8 w-8 object-contain" />
            </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            <motion.a
  href="#home"
  className="flex items-center space-x-1 text-gray-700 hover:text-travel-blue transition-colors"
  whileTap={{ scale: 0.92, backgroundColor: '#e0f2fe' }}
  onClick={e => {
    e.preventDefault();
...
>
  ...
  onClick={e => {
    e.preventDefault();
    document.querySelector('#travel-buddies')?.scrollIntoView({ behavior: 'smooth' });
  }}
>
